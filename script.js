...
//         // Késleltetés beállítása a képek beúsztatásához
...
//             leftImage.style.animation = `slideInFromLeft 6s ease-out ${slideInDelay}ms forwards`;
//             rightImage.style.animation = `slideInFromRight 6s ease-out ${slideInDelay}ms forwards`;
//         }
//     };
